...
public class StaffStatus implements Serializable {
	...
	private long id;
	@Column(name = "STAFF_STATUS_NAME", nullable = false)
	...
	public StaffStatus(long id, String staffStatusName, Date createdDate, boolean isDelete) {
		super();
		this.id = id;
